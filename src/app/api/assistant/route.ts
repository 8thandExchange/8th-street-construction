...
- Vendors/creditors (companies that bill US, e.g. Monte Cristo Consulting) → list_vendors + record_vendor_bill. A vendor's invoice PDF attached in chat: read it, resolve the vendor, and record_vendor_bill with the staged file — that's accounts payable, completely separate from client invoices, and nothing is sent to anyone.
