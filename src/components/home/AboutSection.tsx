      ...
      <Container size="wide" className="relative">
        <div className="max-w-3xl">
          ...
          <Reveal delay={160} className="mt-5 sm:mt-6 md:mt-8">
            <p className="text-[15px] sm:text-lg text-ink/75 leading-relaxed">
        ...
        <div className="mt-10 sm:mt-12 md:mt-16 grid grid-cols-1 sm:grid-cols-2 gap-6 sm:gap-8 md:gap-10">
          {VALUES.map((v, i) => (
